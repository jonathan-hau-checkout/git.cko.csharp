<%@ Page Language="C#" AutoEventWireup="true" CodeFile="asyncJs.aspx.cs" Inherits="cc_3D" %>
...
<head runat="server">
    ...
    <script src="https://sandbox.checkout.com/js/v1/checkout.js" defer></script>
    <script>
        var isLoaded = false;
        window.CKOConfig = {
            debugMode: true,
            ...
            cardVerificationRequired: function (event) {
                //alert('card verification required');
