...
public partial class alternativePayment_callback : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        // Create payload
        //var verifyChargeRequest = new Checkout.ApiServices.Charges.RequestModels.CardIdCharge();

        //var paymentTokenCreateRequest = new Checkout.ApiServices.Charges.RequestModels.
        //{
        //    ChargeMode = 1,
        //    Udf1 = "new token",
        //    AutoCapture = "N"
