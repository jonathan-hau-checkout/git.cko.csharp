<%@ Page Language="C#" AutoEventWireup="true" CodeFile="basic_configure.aspx.cs" Inherits="tokens_LoadJS" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Basic JS - Configure</title>
</head>
<body>
    <form method="post" class="payment-form">
        ...
        <input id="btnOpen" type="button" onclick="Checkout.open()" value="Load Lightbox" disabled />
