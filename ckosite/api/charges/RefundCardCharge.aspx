<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RefundCardCharge.aspx.cs" Inherits="CaptureCardCharge" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Refund Card Charge</title>
</head>
<body>
    <form id="form1" runat="server">
    <div>
    
        <h1 style="box-sizing: border-box; margin: 10px 0px 30px; -webkit-font-smoothing: antialiased; font-style: normal; font-family: 'Open Sans Light', Helvetica, sans-serif; font-size: 24px; font-weight: 300; color: rgb(37, 86, 160); font-variant: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">Refund Card Charge</h1>
        ...
        <div>
            ...
            <br />
            <br />
            Select a card ID to charge to [AutoCapture=Y]:<br />
...
&nbsp;<br />
            ...
            <br />
            <br />
            2. Refund card charge for charge ID
            <asp:Label ID="label_chargeId" runat="server" ViewStateMode="Enabled"></asp:Label>
            <br />
            <br />
            <asp:Button ID="but_refundCharge" runat="server" OnClick="but_refundCharge_Click" Text="Refund Card Charge" />
            <br />
            <br />
            Response:<br />
            <asp:TextBox ID="tb_refundChargeRsp" runat="server" Height="90px" ReadOnly="True" TextMode="MultiLine" Width="700px"></asp:TextBox>
            <br />
            <br />
        ...
        <div style="box-sizing: border-box; color: rgb(49, 59, 75); font-family: 'Open Sans', Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
            <div class="httpRequest" style="box-sizing: border-box;">
                <p style="box-sizing: border-box; line-height: 25px; margin: 20px 0px; color: rgb(49, 59, 75); font-family: 'Open Sans', Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
                    This endpoint refunds a<span class="Apple-converted-space">&nbsp;</span><strong style="box-sizing: border-box;">Card Charge</strong><span class="Apple-converted-space">&nbsp;</span>that has previously been created but not yet refunded. Funds will be refunded to the credit or debit card that was originally charged. You can refund only the original amount that was charged. Once a charge is refunded, it cannot be refunded again. The API will return an error if you try to refund an already-refunded charge, or when trying to refund more money than the original amount charged.</p>
                <div style="box-sizing: border-box; color: rgb(49, 59, 75); font-family: 'Open Sans', Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(255, 255, 255);">
                    <div class="httpRequest" style="box-sizing: border-box;">
                ...
                <table id="refundChargePayLoadsTable" cellpadding="1" cellspacing="1" class="jsonTable" style="box-sizing: border-box; margin: 20px 0px; width: 920px; max-width: 100%; border-collapse: separate; border-radius: 4px; border-spacing: 1px; overflow: hidden; color: rgb(49, 59, 75); font-family: 'Open Sans', Helvetica, sans-serif; font-size: 14px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px; background-color: rgb(197, 209, 230);">
                    ...
                    <tbody style="box-sizing: border-box;">
                        <tr style="box-sizing: border-box; height: 36px;">
                            ...
                            <td style="box-sizing: border-box; font-weight: normal; line-height: 25px; font-size: 13px; padding: 2px 8px; background-color: rgb(255, 255, 255);">Default is the captured amount if not specified. A positive integer (without decimal separator) representing how much of this charge to refund. You can do multiple refunds up to the original amount that was captured.</td>
